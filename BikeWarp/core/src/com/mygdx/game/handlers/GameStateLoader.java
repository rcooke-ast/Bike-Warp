...
//
//	private static final String saveName = "ABstate.dat";
//
...
//		jWorld.display = (ArrayList<int[]>) GameVars.plyrDisplay.clone();
...
//			GameVars.plyrDisplay = (ArrayList<int[]>) jWorld.display.clone();
