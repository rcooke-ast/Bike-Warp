...
public class DecorVars {
    ...
    public static final String[] platformTextures = {"Default", "Asphalt", "Bricks", "Bubbles", "Cracked Mud", "Grass", "Gravel", "Ice", "Mars", "Metal (Black)",  "Metal (Plate)", "Moon", "Sand", "Steel", "Water", "Wood", "Wood Plancks (H)", "Wood Plancks (V)"};
