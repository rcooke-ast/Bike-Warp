...
public class MenuSelectPlayer extends GameState {
    ...
    private String header = "Select your alias, or create a new one!";
	...
	public void handleInput() {
    	if ((GameInput.isPressed(GameInput.KEY_UP)) & (fadeOut==-1.0f)) {
    		...
    		else gsm.setState(GameStateManager.PEEK, false, "none"); // Return to main menu
        }
	}
	...
	public void render() {
        ...
        question.draw(sb, header, (SCRWIDTH-qWidth)/2.0f,(BikeGame.V_HEIGHT+4.0f*qHeight)/2.0f);
        // Render YES
        if (currentOption == 1) {
