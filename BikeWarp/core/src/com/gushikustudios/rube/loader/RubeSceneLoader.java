...
public class RubeSceneLoader
{
    ...
    * well as within the Box2D world that is ultimately returned. This method loads
    * an editor scene. 
    * 
    * @param jsonString
    *           A string that contains the editor scene (json-formatted)
    * @return The cumulative scene
    */
   public RubeScene addEditorScene(String jsonString)
   {
      if (mRubeWorldSerializer != null)
      {
         mRubeWorldSerializer.resetScene();
      ...
      RubeScene scene = json.fromJson(RubeScene.class, jsonString);
      return scene;
   }
